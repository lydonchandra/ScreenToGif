...
internal class HorizontalTrackPreviewRenderer : FrameworkElement
{
    ...
    public static readonly DependencyProperty TracksProperty = DependencyProperty.Register(nameof(Tracks), typeof(ObservableCollection<TrackViewModel>), typeof(HorizontalTrackPreviewRenderer), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender));
    ...
    protected override void OnRender(DrawingContext drawingContext)
    {
        ...
        drawingContext.DrawDrawing(new GeometryDrawing
        {
            ...
            Geometry = new RectangleGeometry(new Rect(MathExtensions.CrossMultiplication(maximum, 800, null), verticalStep * 3 - verticalStep / 2,
        ...
        drawingContext.DrawDrawing(new GeometryDrawing
        {
            ...
            Geometry = new RectangleGeometry(new Rect(MathExtensions.CrossMultiplication(maximum, 2467, null), verticalStep * 4 - verticalStep / 2,
        ...
        drawingContext.DrawDrawing(new GeometryDrawing
        {
            ...
            Geometry = new RectangleGeometry(new Rect(MathExtensions.CrossMultiplication(maximum, 600, null), verticalStep * 5 - verticalStep / 2,
                MathExtensions.CrossMultiplication(maximum, 780, null) / 100 * ActualWidth, verticalStep - verticalStep / 2))
        });

        //Draw currency position.
        drawingContext.DrawDrawing(new GeometryDrawing
        {
            Brush = CurrentBrush,
        ...
        if (SelectionStart.HasValue && SelectionEnd.HasValue)
        {
            drawingContext.DrawDrawing(new GeometryDrawing
            {
                ...
                Geometry = new RectangleGeometry(new Rect(MathExtensions.CrossMultiplication(maximum, SelectionStart.Value.TotalMilliseconds, null), 0,
